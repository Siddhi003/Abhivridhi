...
import com.example.donationapp.databinding.ActivityScrollingBinding
import java.util.*
...
class ScrollingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState : Bundle?) {
        ...
        val array : ArrayList<Donation_details> =
            arrayListOf(Donation_details("Ram prasad", "Farmland got infertile due to severe drought",R.drawable.sampleimage_2),
                        Donation_details("Rani ", "Youngest son suffering from cancer",R.drawable.smapleimage_1),
                        Donation_details("tom ", "factory closed",R.drawable.sample_3)
                       )
        val donationItemAdapter : GenericAdapter<Donation_details> = object : GenericAdapter<Donation_details>(this, array) {
            override val layoutResourceId : Int
                get() = R.layout.item_donation

            override fun onDataBind(model : Donation_details, position : Int, holder : RecyclerView.ViewHolder?) {
                ...
                imageView?.setImageDrawable(ContextCompat.getDrawable(this@ScrollingActivity,model.imageResourse))
